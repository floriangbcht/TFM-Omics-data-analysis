...
Interestingly, the relationships seem to be non-linear, confirming the use of Spearman's correlations. In particular, we observe that for read counts inferior to approximately 6 the relative abundances increase whereas for higher read counts those decrease. It can be illustrated by mean of a broken stick regression: 
